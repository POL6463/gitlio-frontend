...
import IntroSidebarStore, { ProfileState } from '@/store/introSidebarStore'; // 적절한 경로로 변경해주세요
...
const IntroOptionOne: React.FC<IntroOptionProps> = ({ profile }) => {
  ...
  useEffect(() => {
    if (textareaRef.current) {
      ...
      element.style.height = 'auto'; // 일단 auto로 설정하여 높이 초기화
